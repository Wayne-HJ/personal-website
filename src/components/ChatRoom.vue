    ...
    >
      ...
      <div class="header">
        <img
          width="32"
          height="32"
          src="https://static.jianght.eu.org/img/chat.png"
        />
        <div style="margin-left:12px">
          <div>ChatRoom</div>
          <div style="font-size:12px">{{ count }} user online</div>
        </div>
...
export default {
  ...
  methods: {
    ...
    saveMessage(e) {
      ...
      if (!this.$store.state.userId) {
        this.$toast({ type: "warnning", message: "please login first" });
  ...
  computed: {
    ...
    isleft() {
      return function(item) {
        // console.log('item',item.ipAddress);
