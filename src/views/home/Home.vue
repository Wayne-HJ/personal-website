    ...
    <div class="home-banner" :style="cover">
      <div class="banner-container">
        ...
        <h1 class="blog-title animated zoomIn">
          {{ blogInfo.websiteConfig.websiteName || 'Blog'}}
        </h1>
        <!-- 一言 -->
        <div class="blog-intro">
          {{ obj.output || 'You can change your life if you want to.'}} <span class="typed-cursor">|</span>
        </div>
        <!-- 联系方式 -->
      ...
      <v-col md="3" cols="12" class="d-md-block d-none">
        <div class="blog-wrapper">
          <v-card class="animated zoomIn blog-card mt-5">
            <div class="author-wrapper">
              ...
              <div style="font-size: 1.375rem;margin-top:0.625rem">
                {{ blogInfo.websiteConfig.websiteAuthor || '作者'}}
              </div>
              <div style="font-size: 0.875rem;">
                {{ blogInfo.websiteConfig.websiteIntro || '未填写'}}
              </div>
            </div>
            <!-- 博客信息 -->
            <div class="blog-info-wrapper">
              ...
              <div class="blog-info-data">
                <router-link to="/categories">
                  <div style="font-size: 0.875rem">category</div>
                  <div style="font-size: 1.25rem">
              ...
              <div class="blog-info-data">
                <router-link to="/tags">
                  <div style="font-size: 0.875rem">tag</div>
          ...
          <v-card class="blog-card animated zoomIn mt-5 big">
            ...
            <div style="font-size:0.875rem">
              {{ blogInfo.websiteConfig.websiteNotice || 'no information'}}
            </div>
          </v-card>
          <!-- 网站信息 -->
          <v-card class="blog-card animated zoomIn mt-5">
            ...
            <div class="web-info">
              <div style="padding:4px 0 0">
                RunTime:<span class="float-right">{{ time }}</span>
              </div>
              <div style="padding:4px 0 0">
                ViewCount:<span class="float-right">
                  {{ blogInfo.viewsCount || 0}}
                </span>
              </div>
            </div>
          </v-card>
...
export default {
  ...
  methods: {
    ...
    runTime() {
      ...
      str += daysold + "d";
      str += day.getHours() + "h";
      str += day.getMinutes() + "m";
      str += day.getSeconds() + "s";
      this.time = str;
    },
